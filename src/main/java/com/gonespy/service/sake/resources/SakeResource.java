...
public class SakeResource {
  ...
  private Response generateSakeResponse(String request) {
    ...
    // don't expose this - if it was brute-force decrypted, who knows what the raw data might
    // contain?
