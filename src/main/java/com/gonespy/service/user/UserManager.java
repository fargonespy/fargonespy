...
public class UserManager {
    ...
    public static class User {
        ...
        public User(long profileID, String nick, boolean online, String status, String location, String address) {
    ...
    public synchronized User updateStatus(long profileID, String nick, boolean online, String status, String location) {
