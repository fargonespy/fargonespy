...
public abstract class StringUtils {
  ...
  public static String gsLoginProof(
    ...
    final String preHash =
        passwordHash + MD5_FILLER + user + serverChallenge + clientChallenge + passwordHash;
  ...
  public static String hashCertificate(Map<String, String> certificateData) {
    ...
    // SDK MD5:
    // TODO: endian-ness? in SDK when reading the hex string from the cert: // switch endianess,
    // e.g. first character in hexstring is HI byte
