...
// based on https://github.com/AdmiralCurtiss/nintendo_dwc_emulator/blob/master/gamespy/gs_utility.py
public class Crypter {
    ...
    private static void enctypex_funcx(char[] encxkey, byte[] key, byte[] validate, byte[] data, int dataLen) {
