...
public class ServerListService implements Runnable {
    ...
    public static class ListThread extends Thread {
        ...
        private void appendServer(ByteBuffer out, Server server, String[] fields, boolean natNeg, boolean unsolicitedUDP) {
...
//            }
            ...
            LOG.info("server address {}:{} (natneg {}, private IP {}, private port {})",
                    server.getAddress(),
                    server.getPort(),
